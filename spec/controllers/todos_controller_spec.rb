...
RSpec.describe TodosController, :type => :controller do
  ...
  let(:valid_attributes) {
    {body:'have a small talk',project:project}
  }
  ...
  describe "Get status" do
    ...
    it 'starts a todo' do
      todo = Todo.create! valid_attributes
      get :start, {:id => todo.to_param}, valid_session
      event = Event.last
    ...
    it 'pauses a todo' do
      todo = Todo.create! valid_attributes
      get :pause, {:id => todo.to_param}, valid_session
      event = Event.last
    ...
    it 'finish a todo' do
      todo = Todo.create! valid_attributes
      get :finish, {:id => todo.to_param}, valid_session
      event = Event.last
    ...
    it 'remove a todo' do
      todo = Todo.create! valid_attributes
      get :remove, {:id => todo.to_param}, valid_session
      event = Event.last
    ...
    it 'assign a user to todo' do
      todo = Todo.create! valid_attributes
      get :assign, {:id => todo.to_param,:todo=>{:user_id=>user.id}}, valid_session
      event = Event.last
    ...
    it 'create a event when change the assignee' do
      ...
      get :assign, {:id => todo.to_param,:todo=>{:user_id=>user2.id}}, valid_session
    ...
    it 'create a event when a comment is added to a todo' do
      ...
      todo = Todo.create! valid_attributes
      get :comment, {:id => todo.to_param}, valid_session
      event = Event.last
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Todo" do
        ...
        expect(event.eventable).to eq(Todo.first)
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
        {body:'new body',project_id:project.id}
      }
      ...
      it "updates the requested todo" do
        ...
        todo.reload
        expect(todo.body).to eq('new body')
      end
